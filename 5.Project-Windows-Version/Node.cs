/*
Deep Lingo compiler - Parent Node class for the AST (Abstract Syntax Tree).
2018, ITESM CEM.
* IRVIN EMMANUEL TRUJILLO DÍAZ A01370082
* LUIS FERNANDO ESPINOSA ELIZALDE A01375758

  This file is based on the Buttercup compiler - Parent Node 
  class for the AST (Abstract Syntax Tree). Copyright (C) 2013 
